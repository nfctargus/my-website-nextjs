		...
		<div className="grid place-items-center w-full align-middle py-5 gap-2 bg-primary-1 bg-opacity-80 my-24 snap-y snap-mandatory xs:h-auto" id="resume">
			<div className="w-full h-196 grid place-items-center">
				<div className="grid place-items-center">
					<h1 className="text-3xl text-primary-2 font-bold w-fit text-center font-vt323">Relevant Skills</h1>
				</div>
				<div className="w-1/2 max-h-1/2 bg-primary-1 rounded-md xs:w-screen xs:text-sm">
					...
					<br />
					<div className="p-2 max-h-56">
						<h2 className="text-feature-1 font-semibold px-1 text-regular">
							This is some other tech that I am familiar with but haven't use regularly:{" "}
						</h2>
						<ul className="list-disc px-5 text-primary-3">
							<li>Angular</li>
							<li>C#</li>
				...
				<div className="w-1/2 max-h-1/2 bg-primary-1 rounded-md px-1 py-2 snap-center xs:w-screen xs:text-sm">
					...
					<div className="educationItem">
						<div className="flex gap-2">
							...
							<h3 className="text-primary-3 align-middle leading-7">
								•{" "}
								<a className="underline hover:text-feature-2 transition-all duration-150" href="https://threejs-journey.com/">
									https://threejs-journey.com
								</a>
							</h3>
						</div>
						<p className="text-primary-3">This was an incredible tutorial series, a real deep dive into what's possible in ThreeJS.</p>
					</div>
					<div className="educationItem">
						<div className="flex gap-2">
							...
							<h3 className="text-primary-3 align-middle leading-7">
								•{" "}
								<a
									className="underline hover:text-feature-2 transition-all duration-150"
									href="https://www.udemy.com/course/mern-stack-real-time-chat-app-with-express-react-mongodb/"
								>
									Udemy
								</a>
							</h3>
						...
						<p className="text-primary-3">
							This course taught me the fundamental concepts that go into a Chat Application and led me to create my own
						</p>
					</div>
					<div className="educationItem">
						<div className="flex gap-2">
							...
							<h3 className="text-primary-3 align-middle leading-7">
								...
								<a
									className="underline hover:text-feature-2 transition-all duration-150"
									href="https://www.youtube.com/playlist?list=PLpaspowtqj-dA0cRZ1yEZBv0iwdOru-SC"
								>
									YouTube
								</a>
							</h3>
