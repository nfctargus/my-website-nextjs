        ...
        <div className='grid place-items-center h-screen w-screen'>
            <div className='h-3/4 w-11/12 bg-primary-1 p-5 bg-opacity-95 text-primary-2 flex flex-col justify-center align-middle'>
                ...
                <div className='text-white text-lg rounded-md p-2 grid place-items-center xs:text-base'>                  
                    <p className='w-2/3 xs:w-full'>Improved Obsidian is a minecraft mod that I made in Java which has over 1000 downloads. I developed it to suit 2 different modding platforms and also actively update it to keep in line with the most up to date versions of Minecraft.</p>
                    <p className='w-2/3 xs:w-full'>My original iteration was built on the Fabric framework but I have since built it to suit the Forge framework.</p>      
                </div>
            </div>
        </div>
    )
